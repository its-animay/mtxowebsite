...
- July 06, 2025. Added comprehensive audio system with Web Audio API including ascending frequency tones for each letter reveal (M-T-X-O), soft triangle wave for "labs", ethereal chord progression for tagline, subtle chime sounds on hover interactions, ambient drone background atmosphere, and sound control toggle button with mute functionality